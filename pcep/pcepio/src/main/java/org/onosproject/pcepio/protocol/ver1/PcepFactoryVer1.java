...
public class PcepFactoryVer1 implements PcepFactory {
    ...
    //added for Huawei ACTN
    @Override
    public PcepLSReportMsg.Builder buildPcepLSReportMsg() {
        return new PcepLSReportMsgVer1.Builder();
    }

    // added for Huawei ACTN
    @Override
    public PcepLSObject.Builder buildLsObject() {
        return new PcepLSObjectVer1.Builder();
    }
    @Override
