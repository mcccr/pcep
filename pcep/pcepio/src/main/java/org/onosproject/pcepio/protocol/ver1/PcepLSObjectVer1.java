...
import org.onosproject.pcepio.types.ActnNodeTlv;
import org.onosproject.pcepio.types.ActnLinkTlv;
...
public class PcepLSObjectVer1 implements PcepLSObject {
    ...
    reference: draft-dhodylee-pce-pcep-ls-03, section 9.2.

    Seven Protocol-ID values are defined for the LS object:
    ...
    public static final byte LS_PRO_ID_ISIS_ONE_VALUE = 1;
    public static final byte LS_PRO_ID_ISIS_TWO_VALUE = 2;
    public static final byte LS_PRO_ID_OSPFV2_VALUE = 3;
    public static final byte LS_PRO_ID_DIRECT_VALUE = 4;
    public static final byte LS_PRO_ID_STATIC_VALUE = 5;
    public static final byte LS_PRO_ID_OSPFV3_VALUE = 6;
    public static final byte LS_PRO_ID_BGPLS_VALUE = 7;
    public static final byte LS_PRO_ID_ABSTRACT_VALUE = 8;
    ...
    protected static List<PcepValueType> parseOptionalTlv(ChannelBuffer cb) throws PcepParseException {
        log.debug("begin parseOptional Tlvs.");
        ...
        while (MINIMUM_TLV_HEADER_LENGTH <= cb.readableBytes()) {
            ...
            case LinkAttributesTlv.TYPE:
                ...
                break;
            // added by BUPT for ACTN Project
            case ActnNodeTlv.TYPE:
                tlv = ActnNodeTlv.read(cb, hLength);
                break;
            case ActnLinkTlv.TYPE:
                tlv = ActnLinkTlv.read(cb, hLength);
                break;
            default:
