...
public class PcepOpenObjectVer1 implements PcepOpenObject {
    ...
    public static final int DEFAULT_ACTN_PCEP_LS_CAPABILITY_RAWVALUE = 1;
    ...
    protected static LinkedList<PcepValueType> parseOptionalTlv(ChannelBuffer cb) throws PcepParseException {
        ...
        while (4 <= cb.readableBytes()) {
            ...
            case PcepLabelDbVerTlv.TYPE:
                ...
                break;
            case ActnLsCapabilityTlv.TYPE:
                log.debug("ActnLsCapabilityTlv");
                if (ActnLsCapabilityTlv.LENGTH != hLength) {
                    throw new PcepParseException("Invalid length received for ActnLsCapabilityTlv.");
                }
                iValue = cb.readInt();
                tlv = new ActnLsCapabilityTlv(iValue);
                break;
    ...
    public static class Builder implements PcepOpenObject.Builder {
        ...
        public PcepOpenObject build() throws PcepParseException {
            ...
            if (!this.bIsOptionalTlvSet) {
                ...
                PcepValueType tlv;
                // this tlv is skipped temporarily in ACTN Project.
                int iValue1 = DEFAULT_GMPLS_CAPABILITY_TLV_IVALUE;
                tlv = new GmplsCapabilityTlv(iValue1);
                this.llOptionalTlv.add(tlv);

                //Add StatefulPceCapabilityTlv
                int iValue = DEFAULT_STATEFUL_PCE_CAPABILITY_TLV_IVALUE;
                tlv = new StatefulPceCapabilityTlv(iValue);
                log.info("HLK: statefulTlv is {}", tlv.toString());
                this.llOptionalTlv.add(tlv);

                // Add ActnLsCapabilityTlv
                int rawValue = DEFAULT_ACTN_PCEP_LS_CAPABILITY_RAWVALUE;
                tlv = new LsCapabilityTlv(rawValue);
                log.info("HLK: actnTlv is {}", tlv.toString());
                this.llOptionalTlv.add(tlv);
