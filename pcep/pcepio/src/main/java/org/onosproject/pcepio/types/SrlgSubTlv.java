...
/**
 * Created by yby on 16-5-6.
 */
public class SrlgSubTlv implements PcepValueType {

    /*
     * Reference :[RFC4203] /1.3
     *
     *  0                   1                   2                   3
    ...
    protected static final Logger log = LoggerFactory.getLogger(SrlgSubTlv.class);
     ...
     */
    public SrlgSubTlv(int[] srlgValue, short hLength) {
     ...
     */
    public static SrlgSubTlv of(final int[] raw, short hLength) {
        return new SrlgSubTlv(raw, hLength);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SrlgSubTlv) {
            SrlgSubTlv other = (SrlgSubTlv) obj;
    ...
    /**
     * Reads from channel buffer and returns object of SrlgSubTlv.
     *
     * @param c input channel buffer
     * @param hLength length
     * @return object of SrlgSubTlv
     */
    public static PcepValueType read(ChannelBuffer c, short hLength) {
        ...
        return new SrlgSubTlv(iSharedRiskLinkGroup, hLength);
    }


    @Override
    public String toString() {
        MoreObjects.ToStringHelper toStrHelper = MoreObjects.toStringHelper(getClass());
