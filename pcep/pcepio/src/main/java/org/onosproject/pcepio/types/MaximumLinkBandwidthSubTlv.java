...
public class MaximumLinkBandwidthSubTlv implements PcepValueType {
     ...
     * 0                   1                   2                   3
     ...
     The units of Maximum Link Bandwidth is bytes per second.
     */
    ...
    public MaximumLinkBandwidthSubTlv(float rawValue) {
     ...
     */
    public static MaximumLinkBandwidthSubTlv of(final float raw) {
    ...
    public static MaximumLinkBandwidthSubTlv read(ChannelBuffer c) {
        return MaximumLinkBandwidthSubTlv.of(ieeeToFloatRead(c.readInt()) * 8);
    }
